        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Zonas_Clientes_ClienteId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ProductPresentaciones", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ProductPresentaciones_Products_ProductoId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ProductPresentacionId = table.Column<int>(nullable: false),
                    Cantidad = table.Column<int>(nullable: false),
                    Subtotal = table.Column<double>(nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_PedidosDetalles", x => new { x.PedidoId, x.ProductPresentacionId });
                    table.ForeignKey(
                    ...
                    table.ForeignKey(
                        ...
                        column: x => x.ProductPresentacionId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProductPresentaciones_ProductoId",
                table: "ProductPresentaciones",
                column: "ProductoId");
