...
namespace MiAsistenteOnline.Web.Controllers
{
    public class ClientesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Nombres,DNI,Telefono,Celular,Email,Facebook")] Cliente cliente)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Nombres,DNI,Telefono,Celular,Email,Facebook")] Cliente cliente)
        {
            if (id != cliente.Id)
            {
                return NotFound();
